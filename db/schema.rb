...
ActiveRecord::Schema.define(version: 20171030220255) do
  ...
  create_table "movies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "image_url", default: "https://www.classicposters.com/images/nopicture.gif"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "image_url", default: "http://voice4thought.org/wp-content/uploads/2016/08/default2-1.jpg"
